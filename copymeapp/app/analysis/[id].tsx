...
import { StyleSheet, Platform, View, ScrollView, TouchableOpacity } from 'react-native';
...
const styles = StyleSheet.create({
	...
	// Le reste des styles reste identique à celui du fichier shot-analysis.tsx original
	videoContainer: {
		height: 220,
		borderRadius: 12,
		overflow: 'hidden',
