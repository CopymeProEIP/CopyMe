...
class Comparaison:
    ...
    def compare_angles(self, current_angles: Dict[str, float], 
                      reference_angles: Dict[str, Dict[str, float]]) -> List[Improvement]:
        """
        Compare les angles actuels avec les angles de référence et génère des recommandations.

        Args:
            current_angles: Dictionnaire des angles actuels {nom_angle: valeur}
