...
class ObjectDetection:
    ...
    def draw_triangle(self, frame, pt1, pt2, pt3):
        triangle_cnt = np.array([pt1, pt2, pt3])
        cv2.drawContours(frame, [triangle_cnt], 0, (0, 165, 255), -1)
